data:extend{
    ...
    },
    {
        ...
        order = "og[inserter-parts-casting]",
        results = {
    ...
    },
    {
        ...
        icon_size = 64, icon_mipmaps = 4,
        subgroup = "advanced-casting",
        order = "og[automation-core-casting]",
        results = {
    ...
    {
        type = "recipe",
        name = "electronic-components-casting",
        energy_required = 2,
        enabled = true,
        category = "advanced-casting",
        always_show_made_in = true,
        ...
        icon_size = 64, icon_mipmaps = 4,
        subgroup = "advanced-casting",
        order = "og[electronic-components-casting]",
        results = {
    ...
    {
        type = "recipe",
        name = "low-density-structure-casting",
        energy_required = 20,
        enabled = true,
        category = "advanced-casting",
        always_show_made_in = true,
        ...
        icon_size = 64, icon_mipmaps = 4,
        subgroup = "advanced-casting",
        order = "og[low-density-structure-casting]",
        results = {
